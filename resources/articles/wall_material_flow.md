...
If there is a problem with extrusion rate only during the walls, it is better to look at the printing speeds and printing temperature. Perhaps the material doesn't get enough momentum out the nozzle and a greater print speed could help. Perhaps the lines are too thin to extrude properly. Perhaps the material is too cool or too hot.
