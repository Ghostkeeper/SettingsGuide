...
====
Used by some printers, as part of filament switching.
When material is retracted for a filament switch, the material needs to be broken off cleanly so that it can move through the feeder without tangling.
This setting configures part of the procedure to break it cleanly.
