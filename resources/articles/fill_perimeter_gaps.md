...
![A long, thin gap between opposite walls is shown on the left and right side of the image](fill_perimeter_gaps_disabled.png)
![The gaps between walls are filled with material](fill_perimeter_gaps_enabled.png)
