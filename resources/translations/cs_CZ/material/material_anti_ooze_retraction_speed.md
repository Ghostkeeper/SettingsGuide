Rychlost retrakce zabraňující výtoku
====
...
Toto nastavení upravuje rychlost, při které je materiál zatažen do první pozice, aby se zabránilo výtoku. Materiál v této fázi ještě není odlomen. Cílem je, tahem dovnitř, pouze rychle odstranit tlak na tryskovou komoru.
