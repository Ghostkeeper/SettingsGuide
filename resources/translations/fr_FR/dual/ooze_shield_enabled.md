...
![The ooze shield gets printed with the first extruder of a layer, causing an alternating pattern if printing with two extruders](../../../articles/images/ooze_shield.png)
![Some parameters can be adjusted for the ooze shield](../../../articles/images/ooze_shield.svg)
