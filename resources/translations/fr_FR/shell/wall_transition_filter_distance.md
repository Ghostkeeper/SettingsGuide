...
Lorsqu'une transition est supprimée, certaines lignes peuvent devenir temporairement trop larges ou trop fines, dépassant ainsi la [Largeur minimale des lignes de paroi](min_wall_line_width.md). Après tout, il y avait une transition à cet endroit pour mieux s'adapter à la largeur de la pièce. Sans cette transition, le nombre de cordons utilisés sera inférieur ou supérieur à ce qui serait idéal, et la largeur de ces parois sera ajustée en conséquence. Ceci est autorisé jusqu'à la [marge du filtre de transition des parois](wall_transition_filter_deviation.md). Si la largeur des murs varie trop, la transition n'est pas supprimée.
...
**Ce paramètre n'est actuellement pas visible pour l'utilisateur. Le filtre ne peut être ajusté qu'à l'aide de la [marge du filtre de transition des parois](wall_transition_filter_deviation.md). Il affecte non seulement les murs normaux, mais aussi les murs à peau supplémentaire, les murs de soutien, les murs de remplissage et les motifs concentriques**.
