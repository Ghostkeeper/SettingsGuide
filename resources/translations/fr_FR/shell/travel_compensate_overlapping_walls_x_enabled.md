...
![All lines are extruded with their full width, creating a part that will be too wide](../../../articles/images/travel_compensate_overlapping_walls_x_enabled_disabled.png)
![Half of the lines have reduced their width, resulting in a more accurate print](../../../articles/images/travel_compensate_overlapping_walls_x_enabled_enabled.png)
