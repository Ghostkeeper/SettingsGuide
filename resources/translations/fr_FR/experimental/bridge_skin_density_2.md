...
**Si le [débit de la deuxième couche extérieure du pont](bridge_skin_material_flow_2.md) est inférieur à 100%, il y aura également un certain espacement entre les lignes même si la densité est de 100%, car les lignes seront alors plus fines.**
