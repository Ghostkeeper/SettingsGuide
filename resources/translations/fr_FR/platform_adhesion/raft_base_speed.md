...
Lorsque le radeau est utilisé, la [vitesse d'impression de la couche initiale](../speed/speed_print_layer_0.md) s'applique à la couche initiale du modèle, et non à la couche initiale du radeau. Les déplacements à l'intérieur du radeau se feront à la [vitesse de déplacement](../speed/speed_travel.md) ordinaire.
