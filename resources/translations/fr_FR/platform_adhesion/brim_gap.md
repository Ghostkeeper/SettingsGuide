...
En revanche, cela réduit également l'efficacité du bord pour maintenir le modèle collé au plateau d'impression. Avec une zone de contact plus fine, le bord ne pourra pas exercer beaucoup de force sur le modèle pour le maintenir contre les effets du [décolement](../troubleshooting/warping.md).
