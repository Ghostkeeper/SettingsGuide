...
* Le [motif de remplissage] (motif_remplissage.md) est réglé sur Croix ou Croix 3D.
* Les lignes de remplissage sont [multipliées](multiplicateur_de_remplissage.md) par un nombre pair.
