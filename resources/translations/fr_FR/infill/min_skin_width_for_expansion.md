...
Vous pouvez également configurer ce paramètre avec le paramètre [Maximum Skin Angle for Expansion](max_skin_angle_for_expansion.md). Si ce paramètre est modifié, il le sera automatiquement. Ce paramètre est celui qui est effectivement utilisé pour le découpage.
