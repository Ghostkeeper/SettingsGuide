...
Il s'agit d'un paramètre différent de la [jointure en Z](../shell/z_seam_x.md). Les paramètres d'alignement de la jointure en Z déterminent seulement où l'imprimante commencera à imprimer le contour d'une pièce, alors que ce paramètre détermine avec quelle pièce elle commencera.
