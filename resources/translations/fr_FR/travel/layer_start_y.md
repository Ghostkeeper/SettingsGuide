...
Il s'agit d'un paramètre différent de la jointure en Z. Les paramètres d'alignement de la jointure en Z déterminent uniquement l'endroit où l'imprimante commencera à imprimer le contour d'une pièce, alors que ce paramètre détermine la pièce par laquelle elle commencera.
