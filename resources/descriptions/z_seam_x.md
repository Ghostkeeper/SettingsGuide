If the location of the seam is set to "User Specified" in the [Z Seam Alignment](z_seam_type) setting, the seam is placed close to the location specified with the Z Seam X and [Z Seam Y](z_seam_y) settings.
